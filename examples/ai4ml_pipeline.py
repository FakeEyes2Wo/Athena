...
Demonstrates: task definition -> data analysis -> eval spec -> hypothesis
generation -> budget setup -> supervisor decisions.
...
async def main() -> None:
    ...
    # 5. Set up budget and supervisor
    print("\n" + "=" * 60)
    ...
    # Demonstrate supervisor decisions
    scenarios = [
