...
class GuiRequestHandler:
    ...
    async def dispatch(self, method: str, params: dict[str, Any]) -> dict[str, object]:
        ...
        if method == "parse_intent":
            return await service.parse_intent(_require_str(params, "message", "message"))
        ...
        if method == "settings_set":
            return await service.settings_set(_require_dict(params, "patch", "settings patch"))
        if method == "set_project_root":
            return await self.set_project_root(_require_str(params, "path", "project path"))
        ...
        if method == "experiment_get":
            return service.experiment_get(_require_str(params, "experiment_id", "experiment_id"))
        ...
        if method == "experiment_set_sota":
            return service.experiment_set_sota(_require_str(params, "experiment_id", "experiment_id"))
