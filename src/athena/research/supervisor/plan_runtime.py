"""Execution and recovery boundary for durable Supervisor Plans."""
...
AsyncStateAction = Callable[[], Awaitable[None]]
...
class PlanRuntime:
    """Own Plan inputs, workspaces, Agent turns, failure records, and recovery."""
    ...
    def __init__(
        ...
        *,
        ...
        publish_state: AsyncStateAction,
        persist_state: AsyncStateAction,
    ) -> None:
        self._owner = owner
        self._deps = deps
        self._run = run
...
__all__ = ["CompletedPlanTurn", "PlanRuntime"]
