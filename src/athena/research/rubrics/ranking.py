...
def build_hypothesis_priority_prompt(context: HypothesisPriorityContext) -> str:
    ...
    return (
        ...
        "most expensive. Use the supplied runtime and declared dependency context: "
        "a proposal that requires an unavailable core framework or an implausible "
        "from-scratch replacement must receive high implementation, latency, and "
        "risk penalties. Reuse supplied Gate evidence instead of re-running its "
