...
from athena.research.paper_rag.index import pack_vectors, unpack_vectors
...
class PaperLibrary:
    ...
    async def load_paper(
        self, key: str, target: ArtifactStore
    ) -> PaperContent | None:
...
class LibraryVectorCache:
    ...
    def _key(self, paper: PaperContent) -> str:
        ...
        return vectors_key(digest_ref(paper.model_dump_json().encode("utf-8")), self._model)
