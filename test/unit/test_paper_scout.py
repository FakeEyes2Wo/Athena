...
class ScriptedProvider:
    ...
    async def stream(self, config, tools, messages, cancel):
        # messages[0] 是固定的 system prompt，每步真正变的是 messages[1] 的观测
        self.prompts.append(str(messages[1].parts[0].content))
