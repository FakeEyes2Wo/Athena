...
/// Method names shared by protocol clients and servers.
pub mod method {
    ...
    pub fn is_control_method(method: &str) -> bool {
        matches!(method, INITIALIZE | SERVER_SHUTDOWN)
    }
}
...
pub use operations::{
    ThreadForkParams, ThreadStartParams, ThreadSubscribeParams, ThreadUnsubscribeParams,
